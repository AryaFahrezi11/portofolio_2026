        ...
        <div className={`${isLoading ? 'opacity-0' : 'opacity-100 animate-fade-in'} transition-opacity duration-200 relative`}>
                        ...
                        <div className="text-white order-2 lg:order-1 flex flex-col gap-4 sm:gap-6 md:gap-8">
                            ...
                            <FadeIn delay={1.0} direction="up">
                                <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3">
                                    ...
                                    >
                                        <span className="flex items-center justify-center gap-2 font-serif italic">
                                            <span>🚀</span>
            ...
            <div id="about" className="w-full pt-11 sm:pt-12 md:pt-11 lg:pt-13 px-4 sm:px-6 md:px-8 lg:px-12 pb-8 lg:pb-12">
                <div className="container mx-auto max-w-7xl">
                    ...
                    {/* Section Title (About Me - Hero Style) */}
                            ...
                            <div className="relative bg-black rounded-2xl p-4 sm:p-5 md:p-6 lg:p-8">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-center">
                                    ...
                                    <div className="lg:col-span-8 space-y-4 sm:space-y-6 lg:space-y-8 order-2 lg:order-1">
                                        ...
                                        {/* Combined Who am I & My Approach - CLEAN DESIGN */}
                                        <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 space-y-8 backdrop-blur-sm">
                                            {/* Who am I Section */}
                                            <div className="space-y-3">
                                                <h2 className="text-xl sm:text-2xl md:text-3xl font-serif italic font-bold text-white/90">
                                                    Who am I
                                                </h2>
                                                <p className="text-base sm:text-lg md:text-xl text-white/80 leading-relaxed text-justify font-serif italic">
            ...
            <div id="skills" className="w-full pt-11 sm:pt-12 md:pt-11 lg:pt-13 px-4 sm:px-6 md:px-8 lg:px-12 pb-8 lg:pb-12" >
                <div className="container mx-auto max-w-7xl">
                    ...
                    {/* Section Title (My Skills - Hero Style) */}
                    <div className="text-center mb-12 sm:mb-16">
            ...
            < div id="project" className="w-full pt-11 sm:pt-12 md:pt-11 lg:pt-13 px-4 sm:px-6 md:px-8 lg:px-12 pb-8 lg:pb-12" >
                <div className="container mx-auto max-w-7xl">
                    ...
                    {/* Section Title (My Projects - Hero Style) */}
                    <div className="text-center mb-12 sm:mb-16">
                        <FadeIn delay={0.1} direction="down">
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold italic tracking-tight bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-transparent">
                                My Projects
                    ...
                    <div className="flex justify-center mb-10">
                        <motion.nav
                            className="relative p-[1px] rounded-full shadow-lg shadow-cyan-500/5 bg-gradient-to-r from-cyan-500/30 via-blue-500/30 to-purple-500/30 overflow-hidden"
                        >
                                ...
                                {['All', 'Web', 'Mobile'].map((category) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="relative px-5 py-2 md:px-7 md:py-2.5 rounded-full text-xs md:text-sm font-bold tracking-wider transition-colors duration-200 min-w-[80px] md:min-w-[100px] font-serif italic"
                                        >
                                            {isActive && (
                                                <motion.div
                                            ...
                                            <span className={`relative z-10 transition-colors duration-200 ${isActive ? 'text-cyan-400' : 'text-white/40 hover:text-white/70'}`}>
            ...
            < div id="contact" className="w-full min-h-screen pt-11 sm:pt-12 md:pt-11 lg:pt-13 px-4 sm:px-6 md:px-8 lg:px-12 pb-8 lg:pb-12" >
                <div className="container mx-auto max-w-7xl">
                    ...
                    {/* Section Title (Contact Me - Hero Style) */}
                    <div className="text-center mb-12 sm:mb-16">
                        <FadeIn delay={0.1} direction="down">
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold italic tracking-tight bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-transparent">
                                Contact Me
                            ...
                            <div className="relative p-[2px] rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600">
                                <div className="relative bg-black rounded-2xl p-6 sm:p-8 md:p-10">
                                    ...
                                    <div className="flex flex-col gap-8 md:gap-10">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative group">
                                                        ...
                                                        <input
                                                            ...
                                                            className="relative w-full bg-black/50 border border-white/10 text-white rounded-lg px-4 py-3 outline-none focus:border-cyan-500 transition-colors placeholder:text-white/20 font-serif italic"
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative group">
                                                        ...
                                                        <select
                                                            ...
                                                            onChange={handleInputChange}
                                                            className="relative w-full bg-black/50 border border-white/10 text-white rounded-lg px-4 py-3 outline-none focus:border-cyan-500 transition-colors appearance-none cursor-pointer font-serif italic"
                                                        >
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative group h-full min-h-[160px] lg:min-h-full">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={handleInputChange}
                                                        className="relative w-full h-full bg-black/50 border border-white/10 text-white rounded-lg px-4 py-3 outline-none focus:border-cyan-500 transition-colors placeholder:text-white/20 resize-none font-serif italic min-h-[160px]"
                                        ...
                                        {/* Bottom Actions - Centered across whole card */}
                                        <div className="flex flex-col items-center gap-6 pt-2 border-t border-white/5">
                                            ...
                                            <button
                                                ...
                                                className="relative group overflow-hidden rounded-lg p-[2px] focus:outline-none w-full sm:w-fit max-w-[280px] sm:max-w-none"
                                            >
                    ...
                    <div className="relative border-t border-white/10 pt-12">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
                            ...
                            {/* Quick Links */}
                            <div className="space-y-4 sm:space-y-5">
                                <h4 className="text-sm sm:text-base font-bold italic tracking-tight bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-transparent">
                                    Quick Links
                                </h4>
                                    ...
                                    {['Home', 'About', 'Skills', 'Projects', 'Contact'].map((link, index) => (
                                        <li key={index}>
                                            <a
                                                ...
                                                className="group flex items-center gap-2 text-xs sm:text-sm text-white/60 hover:text-white/90 transition-all duration-300 font-serif italic"
                                            >
                                                <span className="w-0 h-[2px] bg-white/20 group-hover:w-4 transition-all duration-300 rounded-full"></span>
                            ...
                            <div className="space-y-4 sm:space-y-5">
                                ...
                                <ul className="space-y-2 sm:space-y-2.5 text-white/60 font-serif italic">
                                    {[
                                        ...
                                        <li key={index} className="flex items-center gap-2 text-xs sm:text-sm group hover:text-white/80 transition-colors duration-300">
                            ...
                            <div className="space-y-4 sm:space-y-5">
                                ...
                                <ul className="space-y-3 sm:space-y-3.5 font-serif italic text-white/60">
                                    ...
                                    <li>
                                        <div className="group flex items-center gap-2 text-xs sm:text-sm">
